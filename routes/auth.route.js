...
import { validateLogout, validateSignIn, validateSignUp, validateEmail, validateResetPin } from "../validations/auth.validation.js";
...
authRouter.post('/verify', validateEmail, authControl.verifyClientEmail);

authRouter.put('/reset/:token', validateResetPin, authControl.resetPin);
